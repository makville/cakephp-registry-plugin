        ...
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
            ...
            switch (yystate) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    this.$ = jSE.cFN.sanitize($$[$0 - 2]) + jSE.cFN.sanitize($$[$0]);
                    break;
                case 10:
                    this.$ = ($$[$0 - 2] * 1) - ($$[$0] * 1);
                    break;
                ...
                case 21:
                    ...
                    break;
                case 22:
                    this.$ = yy.lexer.cellHandler.cellValue.apply(yy.lexer.cell, [$$[$0]]);
                    break;
                case 23:
                    this.$ = yy.lexer.cellHandler.cellRangeValue.apply(yy.lexer.cell, [$$[$0 - 2], $$[$0]]);
                    break;
                case 24:
                    this.$ = yy.lexer.cellHandler.remoteCellValue.apply(yy.lexer.cell, [$$[$0 - 2], $$[$0]]);
                    break;
                case 25:
                    this.$ = yy.lexer.cellHandler.remoteCellRangeValue.apply(yy.lexer.cell, [$$[$0 - 4], $$[$0 - 2], $$[$0]]);
                    break;
                case 26:
